...
function () {
  ...
  _createClass(MetaDataContract, [{
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", this.contract.getPrice());
              ...
              case 2:
                ...
                return _context5.abrupt("return", new Promise(function (resolve, reject) {
                  ipfs.add(base64, function (err, result) {
                    ...
                    console.log(price);
                    return _this.contract.addAddress(address, name, result, {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee6(base64) {
...
//# sourceMappingURL=4.e86ea0efa3e40b72f19e.hot-update.js.map
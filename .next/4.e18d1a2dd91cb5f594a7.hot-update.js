...
function () {
  function MetaDataContract() {
    ...
    this.price = 0;
    this.eth = eth;
    this.network = 3; // console.log("constructed");
  ...
  _createClass(MetaDataContract, [{
        ...
        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", this.contract.getByAddress(__WEBPACK_IMPORTED_MODULE_2_eip55___default.a.encode(address)).then(function (result) {
                  // console.log(result);
    ...
    value: function () {
      ...
      /*#__PURE__*/
      __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee4(address, callback) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee5(blob) {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee6(address, name, image) {
        var _this2 = this;
...
//# sourceMappingURL=4.e18d1a2dd91cb5f594a7.hot-update.js.map
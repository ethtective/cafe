...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState({
        network: metaData.eth.net_version()
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, "Metadata Uploader "), this.state.network !== 3 ? "Please connect to Ropsten" : "", "Ropsten Testnet Contract:", " ", __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("code", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 119
        }
...
//# sourceMappingURL=4.f8f60f62775ac455b9fa.hot-update.js.map
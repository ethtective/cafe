  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      ...
      metaData.getPrice().then(function (result) {
        console.log(result); // this.setState({ price: result });
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, "Upload the following metadata for ", this.state.price, ":"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("form", {
        "class": "",
        noValidate: true,
        autoComplete: "off",
        __source: {
...
//# sourceMappingURL=4.0d11d2512da55b2c0fe7.hot-update.js.map